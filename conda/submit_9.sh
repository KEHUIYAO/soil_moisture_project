...
python train_transformer.py --epochs=100 --early_stopping_patience=10 --save_model='model_8.pt' --save_figure='model_8.png' --save_entire_model='model_entire_8.pt' --num_layers=6 --d_model=512 --d_ff=2048 --h=8
