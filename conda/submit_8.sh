...
python train_transformer.py --epochs=100 --early_stopping_patience=10 --save_model='model_8.pt' --save_figure='model_8.png' --save_entire_model='model_entire_8.pt' --num_layers=4 --d_model=64 --d_ff=256 --h=8
