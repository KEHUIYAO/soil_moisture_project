...
python train.py --lstm_hidden_dim=512 --ffn_hidden_dim=256 --epochs=100 --early_stopping_patience=10 --direct_connection_from_previous_output=True --time_varying_features_name='prcp,srad,tmax,tmin,vp,SMAP_36km' --save_model='model_5.pt' --save_entire_model='model_entire_5.pt' --save_figure='model_5.png'