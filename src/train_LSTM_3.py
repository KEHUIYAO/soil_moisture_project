...
if __name__ == '__main__':
    ...
    parser.add_argument("--parallel", type = str, default='disable', help = 'enable parallel training')
    ...
    # double check if the test data is unused
    print(testing_dataLoader.dataset.indices)
